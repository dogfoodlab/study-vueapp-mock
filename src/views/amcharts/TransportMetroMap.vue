...
export default {
  mounted  () {
    ...
    // Title
    const title = chart.tooltipContainer.createChild(am4core.Label)
    ...
    createLine('Airport Express', am4core.color('#008489'), [
      {
    ...
    createLine('Disneyland Resort Line', am4core.color('#ed6ea7'), [
      {
        station: 'Sunny Bay',
        x: 22.5,
        y: 46.5
    ...
    createLine('East Rail Line', am4core.color('#63b9e9'), [
      {
        station: 'Lok Ma Chau',
        x: 30,
        y: 88
    ...
    createLine('Island Line', am4core.color('#0075bf'), [
      {
    ...
    createLine('Kwun Tong Line', am4core.color('#009e3d'), [
      {
        station: 'Whampoa',
        x: 65,
        y: 38
    ...
    createLine('Ma On Shan Line', am4core.color('#97401d'), [
      {
        station: 'Tai Wai',
        x: 63,
        y: 71
    ...
    createLine('South Island Line', am4core.color('#cdce00'), [
      {
    ...
    createLine('Tseung Kwan O Line', am4core.color('#823f91'), [
      {
        station: 'Tuen Mun',
        x: 6,
        y: 73
    ...
    createLine('Tsuen Wan Line', am4core.color('#e30613'), [
      {
        station: 'Tsuen Wan',
        x: 12,
        y: 62
    ...
    createLine('Tung Chung Line', am4core.color('#f49432'), [
      {
        station: 'Tung Chung',
        x: 14,
        y: 38
    ...
    createLine('West Rail Line', am4core.color('#823f91'), [
      {
        station: 'North Point',
        x: 74,
        y: 24
    ...
    const bg = chart.plotContainer.createChild(am4core.Image)
